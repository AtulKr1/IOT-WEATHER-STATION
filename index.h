...
.widget{
  box-shadow:0 40px 10px 5px rgba(0.1,0.1,0.1,0.1);
  margin:100px auto;
  height: 330px;
  position: relative;
  width: 500px;
...
<div class="widget"> 
  ...
  <div class="midtxt" style="text-align: center;">WEATHER REPORT</div>
  <div class="lower">    
    <ul class="infos">
      <li class="info temp">
  ...
  <div class="lasttxt" style="text-align: right;">ELITE CYBORGS</div>
</div>
